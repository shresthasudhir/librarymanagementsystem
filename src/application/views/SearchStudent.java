...
public class SearchStudent extends Application {
	...
	public void buildData(String searchKeyword) {
		...
		try {
			...
			PreparedStatement pstmt = c.prepareStatement(
				    "SELECT id, firstname , lastname , address, dateOfBirth, contactNumber, username, email from users WHERE status= 3 AND firstname LIKE ? ");
